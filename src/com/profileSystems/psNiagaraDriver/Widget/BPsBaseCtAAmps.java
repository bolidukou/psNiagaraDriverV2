...
public class BPsBaseCtAAmps extends BNumericPoint
{
  /*-
  class BPsBaseCtAAmps
  {
    ...
    properties 
	 {
        ...
        //default{[BFacets.makeNumeric(BUnit.make("ampere", "A", BDimension.DEFAULT), BInteger.make(1), BDouble.make(0), BDouble.make(20))]}
...
/*@ $com.profileSystems.psNiagaraDriver.Widget.BPsBaseCtAAmps(1704378340)1.0$ @*/
...
////////////////////////////////////////////////////////////////
   ...
   * @see com.profileSystems.psNiagaraDriver.Widget.BPsBaseCtAAmps#getFacets
   * @see com.profileSystems.psNiagaraDriver.Widget.BPsBaseCtAAmps#setFacets
   */
   ...
   * @see com.profileSystems.psNiagaraDriver.Widget.BPsBaseCtAAmps#facets
   */
...
////////////////////////////////////////////////////////////////
   ...
   * @see com.profileSystems.psNiagaraDriver.Widget.BPsBaseCtAAmps#getProxyExt
   * @see com.profileSystems.psNiagaraDriver.Widget.BPsBaseCtAAmps#setProxyExt
   */
   ...
   * @see com.profileSystems.psNiagaraDriver.Widget.BPsBaseCtAAmps#proxyExt
   */
...
////////////////////////////////////////////////////////////////
  ...
  public static final Type TYPE = Sys.loadType(BPsBaseCtAAmps.class);
